...
class LaneDetection():
    ...
    def main(self,img):
        ...
        #maske
        color_combined=self.combine_threshold(img)
    ...
    def calculate_ref_points(self,out_img,xm,am):
        ...
        cv2.circle(out_img,(int(xm),int(out_img.shape[0]/2)),1,(255,0,255),2)
        cv2.circle(out_img,(int(am),int(out_img.shape[0]/2)),1,(255,0,255),2)
        
        cv2.circle(out_img,(int(out_img.shape[1]/2),int(out_img.shape[0]/2)),1,(0,0,255),2)
